// Auto-generated from MITRE ATT&CK STIX data v14.1
// enterprise-attack-14.1.json — 201 techniques, 424 sub-techniques

window.ATTACK_MATRIX = {
  tacticOrder: ["reconnaissance", "resource-development", "initial-access", "execution", "persistence", "privilege-escalation", "defense-evasion", "credential-access", "discovery", "lateral-movement", "collection", "command-and-control", "exfiltration", "impact"],
  tacticLabels: {"reconnaissance": "Reconnaissance", "resource-development": "Resource Dev.", "initial-access": "Initial Access", "execution": "Execution", "persistence": "Persistence", "privilege-escalation": "Priv. Escalation", "defense-evasion": "Defense Evasion", "credential-access": "Credential Access", "discovery": "Discovery", "lateral-movement": "Lateral Movement", "collection": "Collection", "command-and-control": "C2", "exfiltration": "Exfiltration", "impact": "Impact"},
  tactics: {
    "reconnaissance": [
      {id:"T1589",name:"Gather Victim Identity Information",subs:[
        {id:"T1589.001",name:"Credentials"},
        {id:"T1589.002",name:"Email Addresses"},
        {id:"T1589.003",name:"Employee Names"},
      ]},
      {id:"T1590",name:"Gather Victim Network Information",subs:[
      ...
      {id:"T1591",name:"Gather Victim Org Information",subs:[
      ...
      {id:"T1597",name:"Search Closed Sources",subs:[
        {id:"T1597.001",name:"Threat Intel Vendors"},
        {id:"T1597.002",name:"Purchase Technical Data"},
      ]},
      {id:"T1598",name:"Phishing for Information",subs:[
    ...
    "resource-development": [
      {id:"T1583",name:"Acquire Infrastructure",subs:[
      ...
      {id:"T1584",name:"Compromise Infrastructure",subs:[
      ...
      {id:"T1588",name:"Obtain Capabilities",subs:[
      ...
      {id:"T1608",name:"Stage Capabilities",subs:[
      ...
      {id:"T1650",name:"Acquire Access",subs:[
      ]},
    ],
    "initial-access": [
      ...
      {id:"T1195",name:"Supply Chain Compromise",subs:[
      ...
      {id:"T1659",name:"Content Injection",subs:[
      ]},
    ],
    "execution": [
      ...
      {id:"T1559",name:"Inter-Process Communication",subs:[
      ...
      {id:"T1648",name:"Serverless Execution",subs:[
      ]},
      {id:"T1651",name:"Cloud Administration Command",subs:[
      ]},
    ],
    "persistence": [
      {id:"T1037",name:"Boot or Logon Initialization Scripts",subs:[
      ...
      {id:"T1137",name:"Office Application Startup",subs:[
      ...
      {id:"T1205",name:"Traffic Signaling",subs:[
        {id:"T1205.001",name:"Port Knocking"},
        {id:"T1205.002",name:"Socket Filters"},
      ]},
      {id:"T1505",name:"Server Software Component",subs:[
      ...
      {id:"T1542",name:"Pre-OS Boot",subs:[
      ...
      {id:"T1556",name:"Modify Authentication Process",subs:[
      ...
      {id:"T1653",name:"Power Settings",subs:[
      ]},
    ],
    "privilege-escalation": [
      ...
      {id:"T1484",name:"Domain Policy Modification",subs:[
    ...
    "defense-evasion": [
      ...
      {id:"T1127",name:"Trusted Developer Utilities Proxy Execution",subs:[
      ...
      {id:"T1216",name:"System Script Proxy Execution",subs:[
      ...
      {id:"T1222",name:"File and Directory Permissions Modification",subs:[
      ...
      {id:"T1480",name:"Execution Guardrails",subs:[
      ...
      {id:"T1497",name:"Virtualization/Sandbox Evasion",subs:[
      ...
      {id:"T1553",name:"Subvert Trust Controls",subs:[
      ...
      {id:"T1578",name:"Modify Cloud Compute Infrastructure",subs:[
      ...
      {id:"T1620",name:"Reflective Code Loading",subs:[
      ]},
      {id:"T1622",name:"Debugger Evasion",subs:[
      ]},
      {id:"T1647",name:"Plist File Modification",subs:[
      ]},
      {id:"T1656",name:"Impersonation",subs:[
      ]},
    ],
    "credential-access": [
      ...
      {id:"T1557",name:"Adversary-in-the-Middle",subs:[
      ...
      {id:"T1606",name:"Forge Web Credentials",subs:[
      ...
      {id:"T1649",name:"Steal or Forge Authentication Certificates",subs:[
      ]},
    ],
    "discovery": [
      ...
      {id:"T1518",name:"Software Discovery",subs:[
      ...
      {id:"T1614",name:"System Location Discovery",subs:[
        {id:"T1614.001",name:"System Language Discovery"},
      ]},
      {id:"T1615",name:"Group Policy Discovery",subs:[
      ]},
      {id:"T1619",name:"Cloud Storage Object Discovery",subs:[
      ]},
      {id:"T1622",name:"Debugger Evasion",subs:[
      ]},
      {id:"T1652",name:"Device Driver Discovery",subs:[
      ]},
      {id:"T1654",name:"Log Enumeration",subs:[
      ]},
    ],
    "lateral-movement": [
    ...
    "collection": [
      ...
      {id:"T1074",name:"Data Staged",subs:[
      ...
      {id:"T1213",name:"Data from Information Repositories",subs:[
      ...
      {id:"T1602",name:"Data from Configuration Repository",subs:[
        {id:"T1602.001",name:"SNMP (MIB Dump)"},
        {id:"T1602.002",name:"Network Device Configuration Dump"},
      ]},
    ],
    "command-and-control": [
      {id:"T1001",name:"Data Obfuscation",subs:[
      ...
      {id:"T1102",name:"Web Service",subs:[
    ...
    "exfiltration": [
      ...
      {id:"T1052",name:"Exfiltration Over Physical Medium",subs:[
    ...
    "impact": [
      ...
      {id:"T1565",name:"Data Manipulation",subs:[
      ...
      {id:"T1657",name:"Financial Theft",subs:[
      ]},
    ],
  },
};